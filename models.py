...
class DCGenerator(nn.Module):
    def __init__(self):
        ...
        self.deconv1 = deconv(100, 256, 4, 1, 0, norm='batch')
        self.deconv2 = deconv(256, 128, 4, 2, 1, norm='batch')
        self.deconv3 = deconv(128, 64, 4, 2, 1, norm='batch')
        self.deconv4 = deconv(64, 32, 4, 2, 1, norm='batch')
        self.deconv5 = deconv(32, 3, 4, 2, 1, norm=' ')
...
class CycleGenerator(nn.Module):
    ...
    def __init__(self, conv_dim=64, init_zero_weights=False, norm='batch'):
        ...
        self.conv1 = conv(3,32,kernel_size=4,stride=2,padding=1,norm='batch')
        self.conv2 = conv(32,64,kernel_size=4,stride=2,padding=1,norm='batch')

        # 2. Define the transformation part of the generator
        self.resnet_block = ResnetBlock(64, norm='batch')

        # 3. Define the decoder part of the generator (that builds up the output image from features)
        self.deconv1 = deconv(64, 32, 4, 2, 1, norm='batch')
        self.deconv2 = deconv(32, 3, 4, 2, 1, norm=' ')
...
class DCDiscriminator(nn.Module):
    ...
    def __init__(self, conv_dim=64, norm='batch'):
        ...
        self.conv1 = conv(3, 32, 4, stride=2, padding=1, norm='batch')
        self.conv2 = conv(32, 64, 4, stride=2, padding=1, norm='batch')
        self.conv3 = conv(64, 128, 4, stride=2, padding=1, norm='batch')
        self.conv4 = conv(128, 256, 4, stride=2, padding=1, norm='batch')
        self.conv5 = conv(256, 1, 1, stride=1, padding=0, norm=' ')
