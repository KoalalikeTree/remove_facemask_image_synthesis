...
@click.command()
@click.option('--network', 'network_pkl', default="pretrain/stylegan2-ffhq-config-e.pkl", help='Network pickle filename', required=True)
...
@click.option('--output', type=str, default="obama.gif", required=True)
def generate_gif(
    network_pkl: str,
    seed: int,
    num_rows: int,
